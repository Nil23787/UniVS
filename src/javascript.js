...
let stars = [];
// Criando 250 estrelas com as propriedades exatas
for(let i=0; i<250; i++) {
    stars.push({
        ...
        speedX: (Math.random() - 0.5) * 0.1, // A deriva lateral exata
...
function draw() {
    // Limpa o canvas mantendo a transparência
...
window.onload = function() {
    // Busca os pontos salvos no "disco" do navegador (Cristais de Lua)
